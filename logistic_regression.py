...
LR=LogisticRegression(random_state=0, C=1.0)
...
print("LR1")
LR1=LogisticRegression(random_state=0, C=1.0)
...
LR2=LogisticRegression(random_state=0, C=1.0)
...
print("LR3")
#
LR3=LogisticRegression(random_state=0, C=1.0)
